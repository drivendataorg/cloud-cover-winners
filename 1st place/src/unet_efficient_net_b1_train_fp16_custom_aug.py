...
class CloudDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, chip_ids_df, 
        ...
        self.low_cloud_covers_chips = chip_ids_df[chip_ids_df.lbl_sz  <0.3].copy().reset_index(drop=True)
    ...
    def __getitem__(self, idx):
        ...
        if self.label_path is not None: 
            ...
            if self.transforms:
                x_arr,y_arr = self.merge_low_chips(chip_id,x_arr,y_arr)

                #x_arr,y_arr = self.cutMix(img.flood_id,x_arr,y_arr,512,p=0)
